...
/**
 * Biblioteca que facilita el uso de entradas y salidas en consola
 * 
 * @author JavierLete
 *
 */
public class Consola {
	...
	// final -> No se puede modificar una vez inicializado (constante = static
	// final)
	 ...
	 * 
	 * @param mensaje mensaje que se quiere mostrar al usuario
	 * @return char introducido (coge el primero escrito, después de eliminar los
	 *         espacios laterales)
	 */
	...
	/**
	 * Lee un s/n de la consola (sin distinguir mayúsculas de minúsculas), mostrando
	 * un mensaje para pedirlo
	 * 
	 * @param mensaje mensaje que se quiere mostrar al usuario
