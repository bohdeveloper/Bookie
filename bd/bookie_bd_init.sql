CREATE DATABASE  IF NOT EXISTS `bookie` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bookie`;
...
CREATE TABLE `libros` (
  ...
  CONSTRAINT `fk_categorias_id` FOREIGN KEY (`categorias_id`) REFERENCES `categorias` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `usuarios` VALUES (1,'administrador','info@admin.com','123456',1);
...
-- Dump completed on 2021-07-23  9:25:18
